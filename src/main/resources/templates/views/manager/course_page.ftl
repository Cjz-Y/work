        ...
        <div class="tpl-left-nav-list">
            <ul class="tpl-left-nav-menu">
                <li class="tpl-left-nav-item">
                    <a href="/manager/coursePage" class="nav-link tpl-left-nav-link-list active">
                ...
                <li class="tpl-left-nav-item">
                    <a href="/manager/banPage" class="nav-link tpl-left-nav-link-list">
                    ...
                    <div class="am-u-sm-12 am-u-md-6">
                        <div class="am-btn-toolbar">
                            <div class="am-btn-group am-btn-group-xs">
                                <button type="button" class="am-btn am-btn-default am-btn-success" onclick="window.location.href='/manager/addCoursePage'">
